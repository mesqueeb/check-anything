...
import { isHttpsUrl } from '../src/index'
...
const tests = {
  ...
  'https://userid:password@example.com:8080': false,
  'https://userid:password@example.com:8080/': false,
  'https://userid@example.com': false,
  'https://userid@example.com/': false,
  'https://userid@example.com:8080': false,
  'https://userid@example.com:8080/': false,
  'https://userid:password@example.com': false,
  'https://userid:password@example.com/': false,
  "https://-.~_!$&'()*+,;=:%40:80%2f::::::@foo.com": false,
  'https://142.42.1.1/': false,
  'https://142.42.1.1:8080/': false,
  'https://223.255.255.254': false,
...
Object.entries(tests).forEach(([url, expected]) => {
  test(url, () => expect(isHttpsUrl(url)).toEqual(expected))
})
